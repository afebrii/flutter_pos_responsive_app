  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          const LabelValue(label: 'Payment Method', value: 'Cash'),
          const Divider(height: 16.0),
          const LabelValue(label: 'Total Quantity', value: '10'),
          const Divider(height: 16.0),
          LabelValue(label: 'Total Bill', value: 1000000.currencyFormatRp),
          const Divider(height: 16.0),
          const LabelValue(label: 'Cashier Name', value: 'John Doe'),
          const Divider(height: 16.0),
          LabelValue(
